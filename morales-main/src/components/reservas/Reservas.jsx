                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="dropdown relative inline-flex">
                        <Link
                          ...
                          className="dropdown-toggle inline-flex text-purple-700 justify-center py-2.5 px-1 items-center gap-2 text-sm text-black rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:text-purple-600  "
                        >
                          Editar
                        </Link>
                      </div>
